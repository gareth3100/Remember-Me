//Global constants used to determine states of code

//These are obviously used to determine the register screen states
...
export const GET_CONTACTS_FAIL = 'GET_CONTACT_FAIL';

//Used to Create Contacts
