    ...
    return(
      <TouchableOpacity style={styles.itemContainer} onPress={() => {
        ...
        <View style={styles.item}>
          <View style={{width: scale(50), height: verticalScale(60), flexDirection: 'row',backgroundColor: colors.purple, justifyContent: 'center', alignItems: 'center', borderRadius: scale(100)}}>
